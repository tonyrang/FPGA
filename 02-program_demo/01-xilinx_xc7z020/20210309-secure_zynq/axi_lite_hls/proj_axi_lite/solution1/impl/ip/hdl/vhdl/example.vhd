...
architecture behav of example is 
    ...
    "example,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-2,HLS_INPUT_CLOCK=13.333000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.966000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=128,HLS_SYN_LUT=123,HLS_VERSION=2019_2}";
    ...
    signal add_ln103_fu_53_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (c_1_vld_reg = ap_const_logic_0) and (c_1_vld_in = ap_const_logic_1)) or (not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_1 = ap_const_logic_1) and (c_1_vld_in = ap_const_logic_1) and (c_1_vld_reg = ap_const_logic_1)))) then
                c_1_data_reg <= add_ln103_1_fu_58_p2;
            end if;
        end if;
    end process;
    ...
    add_ln103_1_fu_58_p2 <= std_logic_vector(unsigned(add_ln103_fu_53_p2) + unsigned(b_read_reg_69));
    add_ln103_fu_53_p2 <= std_logic_vector(unsigned(a_read_reg_64) + unsigned(c_0_data_reg));
    ...
    c_0_ack_out_assign_proc : process(c_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((c_1_ack_in = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3)))) then 
