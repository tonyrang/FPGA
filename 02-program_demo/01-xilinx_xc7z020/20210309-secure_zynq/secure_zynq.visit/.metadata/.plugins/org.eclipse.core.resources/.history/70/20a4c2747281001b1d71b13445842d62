...
int main () 
{
   ...
   //init xExample ip
   XExample_Initialize(&myExample,0);
   //write a
   XExample_Set_a(&myExample,100);
   //write b
   XExample_Set_b(&myExample,100);
   //get c
   uint32_t tmp_c = XExample_Get_c_o(&myExample);

   printf("XExample intput a:100, b:100,output c=%ld\r\n",tmp_c);
