...
HD_PWD='E:/Xilinx-tools/xc7z020-prj/first-020/first-020.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_mcu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source micro_mcu_wrapper.tcl -notrace
