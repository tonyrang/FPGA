...
HD_PWD='E:/Xilinx-tools/xc7z020-prj/first-020/first-020.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_mcu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source micro_mcu_wrapper.tcl
