...
#
# Generated by export_simulation on Sat Apr 11 11:32:32 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './micro_mcu.sh' script.

./micro_mcu.sh -reset_run
...
./micro_mcu.sh -noclean_files

For more information on the script, please type './micro_mcu.sh -help'.
